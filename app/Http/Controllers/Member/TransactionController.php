...
class TransactionController extends Controller
{
    ...
    public function index(): View
    {
        ...
        return view('member.transactions_history', compact('user', 'transactions'),  ['title' => 'Riwayat Transaksi']);
    }
    ...
    public function show(string|int $id): View
    {
        ...
        return view('member.detail', compact('user', 'transactions', 'id'), ['title' => 'Riwayat Transaksi']);
    }
}
