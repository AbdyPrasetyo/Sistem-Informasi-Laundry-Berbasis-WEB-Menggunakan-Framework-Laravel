                            ...
                            <div class="row">
                                <div class="col-10">
                                    <img class="img-circle img-fit float-left" width="100" height="100"
                                        src="{{ asset('before/img/profile/'.$user->profile_picture) }}" alt="Foto Profil">
                                    <div class="member-content">
                                        <h2 class="m-0">{{ $user->name }}</h2>
                                        <p class="small m-0">ID Member: {{ $user->id }}</p>
                                        <a href="{{ route('profile.index') }}" class="btn btn-sm btn-outline-primary btn-fw">Edit
                                            Profil</a>
                                    </div>
                                </div>
                                <div class="col-2 text-center">
                                    ...
                                    <a href="{{ route('member.points.index') }}"
                                        class="btn btn-sm btn-outline-success btn-fw">Tukar
                                        Poin</a>
                                </div>
                            </div>
                        </div>
